  ...
  return (
    <section>
      ...
      <FormCard title={updateCampaignData}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-2 gap-10">
            {volunteer?.length > 0 || donation?.length > 0 ? (
              // Only show status select if volunteer or donation is present
              <div className="col-span-2 space-y-2">
                <span className="text-sm">{status}</span>
                <select
                  value={selectedStatus}
              ...
              // Show the full form fields if neither volunteer nor donation is present
              <>
                <div className="grid grid-cols-1 space-y-2">
                  <span className="text-sm">{introName}</span>
                  <input
