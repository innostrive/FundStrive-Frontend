...
export const View = ({ onClick, className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      ...
      strokeWidth="1.5"
      stroke="currentColor"
      className={twMerge("size-5 text-blue-500", className)}
      onClick={onClick}
    >
      <path
        strokeLinecap="round"
...
export const Delete = ({ onClick, className }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      ...
      strokeWidth="1.5"
      stroke="currentColor"
      className={twMerge("size-5 text-red-300", className)}
      onClick={onClick}
    >
      <path
        strokeLinecap="round"
...
export const SliderIcon = ({ className }) => {
  return (
    ...
    >
      <path
        d="M10 2H14V6H10V2ZM4 8H20V10H4V8ZM2 14H22V16H2V14ZM10 18H14V22H10V18Z"
        fill="currentColor"
      />
    </svg>
  );
